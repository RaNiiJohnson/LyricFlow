...
export const mockArtists: Artist[] = [
  {
    id: "artist-1",
    name: "KATSEYE",
    bio: "KATSEYE is a global girl group formed through the reality competition show 'The Debut: Dream Academy'. The group consists of six members from different countries, representing a new era of international K-pop collaboration.",
    imageUrl:
